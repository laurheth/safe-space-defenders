    ...
    public override void Awake()
    {
        ...
        switch (typenum) {
            ...
            case 0: // Bigot
                ...
                break;
            case 1: // Fash
                actions.Add(new Action("Board with a nail in it", MoveDistance, ActType.Melee, 4, 0, "Unit","*Punch* >:o",Color.white,0,0));
                ...
                break;
            case 2: // Fedorabro
                actions.Add(new Action("Well actually", 6, ActType.Cone, 3, 6, "Unit","Well ACTUALLY...",Color.white,-1,0,false));
                actions.Add(new Action("Ethics", 6, ActType.Cone, 3, 6, "EnemyUnit", "#FedoraGate", Color.cyan,1,1,false));
                break;
            case 3: // RichNimbyMan
                actions.Add(new Action("Money", 0, ActType.Grenade, 10, 20,"EnemyUnit","Seed funds!",Color.green,0,1,false));
                actions.Add(new Action("Gentrification", 6, ActType.Grenade, 6, 4,"Unit","GENTRIFICATION",Color.red,-1,0,false));
                break;
        }
        //actions.Add(new Action("Move", MoveDistance, ActType.Movement, 0,-1,"","",Color.white));
